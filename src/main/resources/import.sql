INSERT INTO modeadministration (descriptionmode) VALUES ("Administracion oral");
INSERT INTO modeadministration (descriptionmode) VALUES ("Inyeccion");

INSERT INTO unitmeasurement (nameum) VALUES ("ml");
INSERT INTO unitmeasurement (nameum) VALUES ("mm");
INSERT INTO unitmeasurement (nameum) VALUES ("cm");
...
INSERT INTO farmacy (namefarmacy, addressfarmacy, lon, latfarmacy, codecityfarmacy, logofarmacy) VALUES ("Farmacia ABC", "calle A30", "-1.0000441", "1.522200", "c001", "logo 1");
INSERT INTO farmacy (namefarmacy, addressfarmacy, lon, latfarmacy, codecityfarmacy, logofarmacy) VALUES ("Farmacia CBA", "carrera 17 - 30", "-1.0000441", "1.522200", "c002", "logo 2");

-- INSERT INTO farmacymedicine (idfarmacy, id, price) VALUES (1, 2, 8000);
-- INSERT INTO farmacymedicine (idfarmacy, id, price) VALUES (2, 1, 50000);
